  ...
  <div class="reply__body">
    ...
    <form action="#">
      ...
      <svg class="confirm ldt-bounce-in" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="38px" height="38px" viewBox="0 0 448.8 448.8"
      ...
      <svg class="reject ldt-bounce-in " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        version="1.1" id="圖層_1" x="0px" y="0px" viewBox="0 0 100 100"
        ...
        <div class="footer__contacts">
          <div class="footer__contacts-item">
            ...
            <div class="footer__contacts-tel">
              <a href="tel:<?php the_field('first_phone', 2) ?>"><?php the_field('first_phone', 2) ?></a>
              <a href="tel:<?php the_field('second_phone', 2) ?>"><?php the_field('second_phone', 2) ?></a>
            </div>
          </div>
          <div class="footer__contacts-item">
            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель"
              class="footer__contacts-logo">
            <address>
